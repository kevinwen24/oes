            ...
            for (int i = 0;i < beanNodes.getLength();i++) {
                ...
                if (propertyNodes != null) {
                    for (int j = 0; j < propertyNodes.getLength(); j++) {
                        ...
                        Element beanPropertyElement = (Element)propertyNodes.item(j);
    ...
    public Object getBean(String id) {
        if (beans.containsKey(id)) {
            ...
            try {
                ...
                // DI
                List<BeanProperty> beanPropertyList = beanConfig.getBeanPropertys();
             ...
             if (object.getClass().getPackage().getName().equals("com.kevin.oes.service.impl")) {
                 ConnectionDynamicProxy connectionDynamicProxy = new ConnectionDynamicProxy();
                 connectionDynamicProxy.setTarget(object);
                 Object proxyObject = Proxy.newProxyInstance(object.getClass().getClassLoader(), object.getClass().getInterfaces(),connectionDynamicProxy);
                 return proxyObject;
             }
                return object;
            } catch (Exception e) {

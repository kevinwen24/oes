            ...
            <div class="form_container">
                 ...
                 <form action="login.action" method="post" id="loginForm" name="loginForm">
                        <div class="input_line  input_line_userName">
                            <input type="text" name="userName" class="input_userName" placeholder="User name"><span id="error_userName"></span>
                            <input type="hidden" name="go" value="<%= (String)request.getAttribute("go")%>">

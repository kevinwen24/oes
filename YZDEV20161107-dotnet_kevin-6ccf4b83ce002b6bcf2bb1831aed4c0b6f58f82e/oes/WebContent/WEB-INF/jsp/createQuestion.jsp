    ...
    <div id="main">
        ...
        <div class="content">
          <div class="create_question">
            <form action="SaveQuestion" method="post" id="createQuestion_from">
            <ul>
              <li>
                 <span class="question_span">Question</span>
                 <textarea  name="questionTitle" class="question_title" style="margin-left:20px;"  id="question_title" > </textarea> 
              </li>
              <li>
                 <span>Answer</span>
                 <ul class="answer_li">
